...
import org.FXChemiEngine.math.MatrixTransforms.MatrixTransforms;
...
import static org.FXChemiEngine.util.Utils.Interpolate;
...
public abstract class Shape extends EngineObject implements Painting {
    ...
    public void paintCenter() {
        ...
        if(zero != null)
            parent.drawingObject.draw((int) zero.x, (int) zero.y, Constants.centerColor);//paint center point
    }
